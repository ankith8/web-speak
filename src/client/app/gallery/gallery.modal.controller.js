(function(){
  ...
  GalleryModalController.$inject = ['data','$uibModalInstance','speechRecognitionService'];

  function GalleryModalController(data,$uibModalInstance,speechRecognitionService) {
      var vm = this;
